    ...
    card.innerHTML = `
        <div class="card-top">
            ...
            <div class="card-top-actions">
                ${enabled ? `
                <button class="btn-icon copy" title="Copy URL" onclick="event.stopPropagation(); ProxyCard.copyUrl('http://${displayIP}:${proxy.port}', this)">
                ...
                <a class="card-url" href="http://${displayIP}:${proxy.port}" target="_blank" title="http://${displayIP}:${proxy.port}">
